      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Production vitamin Matching v2 remains quarantined until the Phase 13.49 gates pass. The completed recovery observed 248 of 322 Spring Valley anchors, retained 74 explicit catalog gaps, and normalized retained PDP evidence under the approved Search and PDP ceilings. Final read-only shadow 2026.08.25-spring-valley-coverage-shadow-6 uses Product Pack 1.2.7 and contains 2,398 pair cases across 152 observed Walmart products and 1,335 competitor products. It has 2,392 unresolved cases and only six semantically audited deterministic candidates; zero candidate relies on an inferred/default hard-blocker value, violates a hard blocker, contains prohibited noise, or crosses the senior/adult boundary. Minimum product-evidence coverage selects 928 pair calls to inspect all 1,067 distinct products with unresolved hard evidence, deferring 1,461 redundant calls. Historical usage projects $38.34 and a $50 aggregate maximum is proposed. The shadow remains unimported and no new AI call is authorized until the owner explicitly accepts both the replacement and paid-work ceiling.",
