        ...
        },
        {
          ...
          rows: [
            [
              ...
              "The immutable runs estimate 77,663 credits ($155.326) and enforce combined per-run ceilings of $170, leaving $30 uncommitted. Search starts are shared-limit governed at three per second and 180 per minute per retailer, with three worker replicas and unique owners. A completed request now refills its slot without waiting for a slow batch peer, and claims round-robin collection-run/retailer lanes so older or larger scopes cannot monopolize capacity. Durable leases, heartbeats, retailer gates, shared cooldowns, retry limits, cancellation, budgets, and immutable raw evidence are unchanged. Collection, documentation, and static checks pass. No PDP or OpenAI spend is authorized by this phase; final credit and artifact reconciliation remains pending terminal runs.",
            ],
            [
              "2026-08-29",
