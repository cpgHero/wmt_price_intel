        ...
        },
        {
          ...
          rows: [
            ...
            [
              ...
              "The audit of 105 older Luna proposals found only two image-sourced claims and 103 structured restatements. The corrected 25-case pilot ultimately completed 25 of 25 for $0.2225386 and produced 67 image-sourced proposals with exact URLs, visible text, at least 0.90 confidence, and no cross-case claim conflicts. Semantic review found eight proposals that attempted to restate or replace already resolved values, including materially different dosage-form and life-stage values. Prompt/schema 1.3.0 now binds each image URL to its exact listing and only attributes missing or declared unknown on that side; the API independently makes legacy rewrites ineligible. The remaining 59 claims target genuinely unresolved evidence. No proposal was verified, no relationship was certified, and reporting did not change. The next bounded scope is 883 distinct-evidence cases covering all 1,020 unresolved product identities, not all 2,316 pair cases. Human verification, derived recomputation, certification, and publication remain separate gates; normalized-unit pricing still cannot create a match.",
            ],
            [
              "2026-08-25",
