...
const relationships: Relationship[] = [
  {
    ...
    benchmark_product_name: "Benchmark milk",
    benchmark_image_url: null,
    competitor_product_id: "a-1",
    competitor_product_name: "Friendly Farms milk",
    competitor_brand: "Friendly Farms",
    competitor_brand_type: "private_label",
    competitor_image_url: null,
    profile_id: "strict",
  ...
  },
  {
    ...
    competitor_product_name: "Regional milk",
    competitor_brand: "Regional Dairy",
    competitor_brand_type: "regional",
    competitor_image_url: null,
    profile_id: "strict",
    profile_label: "Strict package",
    comparison_metric: "package_price",
