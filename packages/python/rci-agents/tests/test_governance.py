...
from rci_agents.governance import canonical_bytes
                ...
                "sections": [
                    {
                        ...
                        "body_template": (
                            ...
                            "{{metric:amazon-walmart-lower-rate|percent_1}} versus Amazon."
                        ),
                        "metric_refs": [
                    ...
                    },
                    {
                        ...
                        "body_template": (
                            ...
                            "{{metric:metric-aldi-organic-85-15-gap-per-lb|currency_2}}."
                        ),
                        "metric_refs": ["metric-aldi-organic-85-15-gap-per-lb"],
        ...
        return ProviderResponse(
            result={
                "sections": [
                    {
                        "id": "executive_summary",
                        "body_template": "Walmart leads by 12.5%.",
                        "metric_refs": ["amazon-walmart-lower-rate"],
                        "evidence_refs": ["evidence-exact-amazon"],
                    },
                    {
                        "id": "recommendations",
                        "body_template": "Prioritize the largest validated gap.",
                        "metric_refs": ["metric-aldi-organic-85-15-gap-per-lb"],
                        "evidence_refs": ["evidence-exact-aldi"],
                    },
                ]
...
async def test_governed_assistant_adds_interpretation_without_mutating_metrics() -> None:
    ...
    assert "while Walmart is lower" in enriched["narratives"]["sections"][0]["body"]
