...
- Administrator retry rounds are capped at three per case. The migration enforces the lineage range
  and the API enforces the operating policy.
...
6. a case at the three-round administrator retry ceiling; or
