...
METRICSCART_POST_429_RPS=1
METRICSCART_POST_429_RPM=54
METRICSCART_POST_429_RECOVERY_SECONDS=1800
METRICSCART_RATE_LIMIT_BACKOFF_SECONDS=150
...
5. Deploy `api`. Its pre-deploy log must show Alembic at the repository's single current migration
   head (System Operations currently expects `0054_account_access_foundation`); then verify
